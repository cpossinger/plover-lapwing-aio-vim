...
from plover_vim.relative_number.builtins import (
    RelativeNumberLookup as RelativeNumberLookup,
)
from plover_vim.relative_number.util import addWhitespace, double, down, reverse, up
...
if __name__ == "__main__":
    ...
    dict = {
        **JosiahLookup.dictionary.items_str_dict(),
    }
